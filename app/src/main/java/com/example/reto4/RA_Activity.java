...
public class RA_Activity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Restaurante A");
...
//        tabLayout.setupWithViewPager(viewPager); -> CRASH SI LA DEJO, NO CRASH SI NO LA PONGO
